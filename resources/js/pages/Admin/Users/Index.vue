...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-muted-foreground">
                    Gérer les comptes propriétaires d'entreprises
                </p>
            </div>
            <Button as-child>
        ...
        <div v-else class="flex min-h-[400px] flex-col items-center justify-center rounded-lg border border-dashed border-sidebar-border/70 p-8 text-center">
            ...
            <h3 class="mb-2 text-lg font-semibold">Aucun utilisateur pour le moment</h3>
        ...
        >
            <p class="text-sm text-muted-foreground">
                Affichage de {{ users.meta?.from }} à {{ users.meta?.to }} sur
                {{ users.meta?.total }} utilisateurs
            </p>
            <div class="flex gap-2">
                <Button
                    ...
                    size="sm"
                >
                    <Link :href="users.links.prev">Précédent</Link>
                </Button>
                <Button
                    ...
                    size="sm"
                >
                    <Link :href="users.links.next">Suivant</Link>
                </Button>
            </div>
        </div>
